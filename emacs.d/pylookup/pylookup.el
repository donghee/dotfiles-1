...
(defun pylookup-exec-get-cache ()
  ...
  (split-string
   (with-output-to-string
	 ...
	 ;; 	   "-c")
	 (call-process-shell-command "cmd /c C:\\Python26\\python.exe \"C:\\Documents and Settings\\donghee\\Application Data\\.emacs.d\\pylookup\\pylookup.py\"" nil standard-output nil "-d" (expand-file-name pylookup-db-file) nil "-c")
)
)
)
...
(defun pylookup-lookup (search-term)
  ...
  (let ((matches (pylookup-exec-get-cache search-term)))
    (cond
...
(defun pylookup-update (src)
 ...
 (call-process-shell-command "cmd /c C:\\Python26\\python.exe \"C:\\Documents and Settings\\donghee\\Application Data\\.emacs.d\\pylookup\\pylookup.py\"" nil standard-output nil "-d" (expand-file-name pylookup-db-file) nil "-l" src)
