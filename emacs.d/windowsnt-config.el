...
;;; emacs-nav
(setq nav-quickfile-list (list
                          "~/.emacs"
                          "c:/work/workspace/EmbeddedTddWorkshop/ChordedKeyboard/src/keyboard/debounce.c"
                          "c:/work/workspace/EmbeddedTddWorkshop/ChordedKeyboard/tests/test_debouncing.cpp"))

(setq nav-quickdir-list (list
                         "c:/work/workspace/EmbeddedTddWorkshop/ChordedKeyboard"
                         "c:/work/workspace/EmbeddedTddWorkshop/ChordedKeyboard/tests"
                         "c:/work/workspace/EmbeddedTddWorkshop/ChordedKeyboard/src"))
